...
class Application {
    ...
    // Async method - fetchData requires a modern JavaScript environment or polyfill for `fetch`
    async fetchData() {
        try {
            // Ensure fetch API is available (e.g., for Node.js, use 'node-fetch' or 'axios')
...
(async () => {
    ...
    const sequence = app.generateSequence();
...
async function fetchUserData(
    userId,
    { includeProfile = false, includePosts = false } = {},
) {
